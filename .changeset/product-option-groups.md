...
**Breaking:** requires `@laioutr-core/canonical-types` 0.31.0 or newer, where `sku` and `status` on the default variant are defined. Upgrade it alongside this release.
